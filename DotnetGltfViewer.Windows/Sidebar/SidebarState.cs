...
namespace DotnetGltfViewer.Windows.Sidebar {
    ...
    public class SidebarState {
        ...
        public static readonly string[] ToneMapModes = ["Khr Pbr Neutral", "ACES Narkowicz", "ACES Hill", "ACES Hill Exposure Boost", "None"];
        ...
        public List<string> AvailableEnvironments { get; } = [];
        ...
        public List<string> AvailableAnimations { get; } = [];
        ...
        public void ScanAvailableEnvironments() {
            ...
            SelectedEnvironmentIndex = cannonIndex >= 0 ? cannonIndex :
                AvailableEnvironments.Count > 0 ? 0 : -1;
        }
        ...
        public string GetSelectedModelPath() {
            ...
            if (SelectedFlavorIndex < 0
                || SelectedFlavorIndex >= AvailableFlavors.Count) {
                return null;
            }
        ...
        public string GetSelectedEnvironmentPath() {
            if (SelectedEnvironmentIndex < 0
                || SelectedEnvironmentIndex >= AvailableEnvironments.Count) {
                return null;
            }
